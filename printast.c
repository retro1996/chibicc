...
static const char kNodeKindStr[476][21] = {
    ...
    "ASM", "CAS", "EXCH", "CAS_N", "EXCH_N", "LOAD", "LOAD_N", "STORE", "STORE_N", "TESTANDSET", "TESTANDSETA", "CLEAR", "RELEASE", "FETCHADD", "FETCHSUB", "FETCHXOR", "FETCHAND",  
    "FETCHOR", "SUBFETCH", "SYNC", "BUILTIN_MEMCPY",  "BUILTIN_MEMSET", "BUILTIN_CLZ", "BUILTIN_CTZ", "POPCOUNT",    
    "RETURN_ADDR", "BUILTIN_ADD_OVERFLOW", "BUILTIN_SUB_OVERFLOW",  "BUILTIN_MUL_OVERFLOW", "UADD_OVERFLOW",
    "UADDL_OVERFLOW", "UADDLL_OVERFLOW", "UMUL_OVERFLOW", "UMULL_OVERFLOW", "UMULLL_OVERFLOW",
    "BSWAP16", "BSWAP32", "BSWAP64", "ALLOCA", "ABORT", "EXPECT", "EMMS", "LFENCE", "MFENCE",
    "SFENCE", "PAUSE", "STMXCSR", "LDMXCSR", "CVTPI2PS", "CVTPS2PI", "CLFLUSH", "VEC_INIT_V2SI",
    "VEC_EXT_V2SI", "VEC_EXT_V4SI", "VEC_INIT_V8QI", "VEC_INIT_V8QI", "PACKSSWB", "PACKSSDW",
    "PACKUSWB", "PUNPCKHBW", "PUNPCKHWD", "PUNPCKHDQ", "PUNPCKLBW", "PUNPCKLWD", "PUNPCKLDQ",
    "PADDB", "PADDW", "PADDD", "PADDQ", "PADDSB", "PADDSW", "PADDUSB", "PADDUSW", "PSUBB", 
    "PSUBW", "PSUBD", "PSUBQ", "PSUBSB", "PSUBSW", "PSUBUSB", "PSUBUSW", "PMADDWD", "PMULHW", 
    "PMULLW", "PSLLW", "PSLLWI", "PSLLD", "PSLLDI", "PSLLQ", "PSLLQI", "PSRAW", "PSRAWI", "PSRAD",
    "PSRADI", "PSRLW", "PSRLWI", "PSRLD", "PSRLDI", "PSRLQ", "PSRLQI", "PAND", "PANDN", "POR", 
    "PXOR", "PCMPEQB", "PCMPGTB", "PCMPEQW", "PCMPEQD", "PCMPGTW", "PCMPGTD", "ADDSS", "SUBSS", "MULSS", 
    "DIVSS", "SQRTSS",  "SQRTPS",  "RSQRTSS", "RSQRTPS", "RCPSS",  "RCPPS", "MINSS", "MINPS", 
    "MAXPS", "MAXSS", "ANDPS", "ANDNPS", "ORPS", "XORPS", "CMPEQSS", "CMPLTSS", "CMPLESS", "MOVSS",
    "CMPNEQSS", "CMPNLTSS", "CMPNLESS", "CMPORDSS", "CMPUNORDSS", "CMPEQPS", "CMPLTPS", "CMPLEPS",
    "CMPGTPS", "CMPGEPS", "CMPNEQPS", "CMPNLTPS", "CMPNLEPS", "CMPNGTPS", "CMPNGEPS", "CMPORDPS",
    "CMPUNORDPS", "COMIEQ", "COMILT", "COMILE", "COMIGT", "COMIGE", "COMINEQ", "UCOMIEQ", "UCOMILT",
    "UCOMILE", "UCOMIGT", "UCOMIGE", "UCOMINEQ", "CVTSS2SI", "CVTSS2SI64", "CVTTSS2SI", "CVTTSS2SI64",
    "CVTTPS2PI", "CVTSI2SS", "CVTSI642SS", "MOVLHPS", "MOVHLPS", "UNPCKHPS", "UNPCKLPS", "LOADHPS",
    "STOREHPS", "LOADLPS", "STORELPS", "MOVMSKPS", "SHUFPS", "SHUFFLE", "PMAXSW", "PMAXUB", "PMINSW",
    "PMINUB", "PMOVMSKB", "PMULHUW", "MASKMOVQ", "PAVGB", "PAVGW", "PSADBW", "MOVNTQ", "MOVNTPS", "SHUFPD", 
    "ADDSD", "SUBSD", "MULSD", "DIVSD", "SQRTPD", "SQRTSD", "MOVSD", "MINPD", "MINSD", "MAXPD", "MAXSD", 
    "ANDPD", "ANDNPD", "ORPD", "XORPD", "CMPEQPD", "CMPLTPD", "CMPLEPD", "CMPGTPD", "CMPGEPD", "CMPNEQPD", 
    "CMPNLTPD", "CMPNLEPD", "CMPNGTPD", "CMPNGEPD", "CMPORDPD", "CMPUNORDPD", "CMPEQSD", "CMPLTSD", 
    "CMPLESD", "CMPNEQSD", "CMPNLTSD", "CMPNLESD", "CMPORDSD", "CMPUNORDSD", "COMISDEQ", "COMISDLT", 
    "COMISDLE", "COMISDGT", "COMISDGE", "COMISDNEQ", "UCOMISDEQ", "UCOMISDLT", "UCOMISDLE", "UCOMISDGT", 
    "UCOMISDGE", "UCOMISDNEQ", "MOVQ128", "CVTDQ2PD", "CVTDQ2PS", "CVTPD2DQ", "CVTPD2PI", "CVTPD2PS",
    "CVTTPD2DQ", "CVTTPD2PI", "CVTPI2PD","CVTPS2DQ", "CVTTPS2DQ", "CVTPS2PD", "CVTSD2SI", "CVTSD2SI64",
    "CVTTSD2SI", "CVTTSD2SI64", "CVTSD2SS", "CVTSI2SD", "CVTSI642SD", "CVTSS2SD", "UNPCKHPD", "UNPCKLPD",
    "LOADHPD", "LOADLPD", "MOVMSKPD", "PACKSSWB128", "PACKSSDW128", "PACKUSWB128", "PUNPCKHB128", "PUNPCKHWD128",
    "PUNPCKHDQ128", "PUNPCKHQDQ128", "PUNPCKLBW128", "PUNPCKLWD128", "PUNPCKLDQ128", "PUNPCKLQDQ128",
    "PADDSB128", "PADDSW128", "PADDUSB128", "PADDUSW128", "PSUBSB128", "PSUBSW128", "PSUBUSB128", "PSUBUSW128", 
    "PMADDWD128", "PMULHW128", "PMULUDQ", "PMULUDQ128", "PSLLWI128", "PSLLDI128", "PSLLQI128", "PSRAWI128",
    "PSRADI128", "PSRLWI128", "PSRLDI128", "PSRLQI128", "PSLLW128", "PSLLD128", "PSLLQ128", "PSRAW128", 
    "PSRAD128", "PSRLW128", "PSRLD128", "PSRLQ128", "PANDN128", "PMAXSW128", "PMAXUB128", "PMINSW128", "PMINUB128",
    "PMOVMSKB128", "PMULHUW128", "MASKMOVDQU", "PAVGB128", "PAVGW128", "PSADBW128", "MOVNTI", "MOVNTI64",
    "MOVNTDQ", "MOVNTPD", "PARITY", "PARITYL", "PARITYLL", "MWAIT", "MONITOR", "ADDSUBPS", "HADDPS", "HSUBPS", 
    "MOVSHDUP", "MOVSLDUP", "ADDSUBPD", "HADDPD", "HSUBPD", "PHADDW128", "PHADDD128", "PHADDSW128", 
    "PHADDW", "PHADDD", "PHADDSW", "PHSUBW128", "PHSUBD128", "PHSUBSW128", "PHSUBW", "PHSUBD", "PHSUBSW", 
    "PMADDUBSW128", "PMADDUBSW", "PMULHRSW128", "PMULHRSW", "PSHUFB128", "PSHUFB", "PSIGNB128", "PSIGNW128", 
    "PSIGND128", "PSIGNB", "PSIGNW",  "PSIGND", "PABSB128", "PABSW128", "PABSD128",  "PABSB", "PABSW", "PABSD", 
    "PTESTZ128", "PTESTC128", "PTESTNZC128", "PBLENDVB128", "BLENDVPS", "BLENDVPD", "PMINSB128", "PMAXSB128", 
    "PMINUW128", "PMAXUW128", "PMINSD128", "PMAXSD128", "PMINUD128", "PMAXUD128", "PMULDQ128", "PHMINPOSUW128",
    "PMOVSXBD128", "PMOVSXWD128", "PMOVSXBQ128", "PMOVSXDQ128", "PMOVSXWQ128", "PMOVSXBW128",  "PMOVZXBD128", 
    "PMOVZXWD128", "PMOVZXBQ128", "PMOVZXDQ128", "PMOVZXWQ128", "PMOVZXBW128", "PACKUSDW128", "MOVNTDQA", 
    ...
    "VZEROALL", "VZEROUPPER", "FEMMS", "BSRSI", "RDPMC", "RDTSCP", "ROLQI", "ROLHI", "RORQI", "RORHI", "BSRDI"
